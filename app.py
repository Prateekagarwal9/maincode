try:
    ...
    def result():
        ...
        dic['parameters']['SalesForceSchema']={}
        dic['parameters']['SalesForceSchema']['value']=salesforceschema
        dic['parameters']['SalesForceTables']={}
        dic['parameters']['SalesForceTables']['value']=salesforcetables
        ...
        dic['parameters']['SAPSchema']={}
        dic['parameters']['SAPSchema']['value']=sapschema
        dic['parameters']['SAPTables']={}
        dic['parameters']['SAPTables']['value']=saptable
        li = []
